    ...
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="alert alert-success" role="alert">
                ...
                {{--                <a href="{{route('companies.restore',[session()->get('companyId'), session()->get('deletedWorkersIds') ] )}}">Do you want restore company?</a>--}}
...
@if(session('workerDeletedSuccessfully'))
    <div class="row justify-content-center">
        <div class="col-md-11">
            <div class="alert alert-success" role="alert">
                <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                ...
                {{session()->get('workerDeletedSuccessfully')}}
            </div>
        </div>
    </div>
